...
struct Graph2* createGraph(int V)
{
...
void addEdge(struct Graph2* graph, int src, int dest, int weight)
{
...
void dijkstra(struct Graph2* graph, int src)
{
...
//{
//
//    std::shared_ptr<Graph> newGraph = std::make_shared<Graph>(5);
